...
static const struct UnitDefinition CH3_BANDITS[] = {
    ...
    UNIT_ENTRY(CHARACTER_CUTTHROAT_8E, CLASS_MERCENARY, FACTION_ID_RED, NO_ITEM_DROP, AUTOLEVEL, 2, 15, 2, 1, REDAs_MERCENARY1_ENEMY, 0, 3, 9, 0, ITEM_SWORD_IRON, ITEM_VULNERARY),
    ...
    UNIT_ENTRY(CHARACTER_CUTTHROAT_8E, CLASS_BRIGAND, FACTION_ID_RED, ITEM_DROP, AUTOLEVEL, 3, 5, 9, 1, REDAs_BRIGAND5_ENEMY, 0, 3, 0, 0x1B, ITEM_AXE_IRON),
