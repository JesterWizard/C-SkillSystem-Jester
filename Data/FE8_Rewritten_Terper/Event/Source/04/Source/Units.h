...
static const struct UnitDefinition CH4_ENEMY_UNITS[] = {
    UNIT_ENTRY(CHARACTER_MONSTER_B8, CLASS_MOGALL, FACTION_ID_RED, NO_ITEM_DROP, AUTOLEVEL, 1, 11, 6, 0, REDAs_NULL, 0, 3, 0xC, 0, ITEM_MONSTER_EVIL_EYE), 
    ...
    UNIT_ENTRY(CHARACTER_ENTOMBED_CH4, CLASS_ENTOMBED, FACTION_ID_RED, NO_ITEM_DROP, AUTOLEVEL, 1, 13, 13, 0, REDAs_NULL, 0, 3, 0xC, 0, ITEM_MONSTER_FETID_CLAW),
