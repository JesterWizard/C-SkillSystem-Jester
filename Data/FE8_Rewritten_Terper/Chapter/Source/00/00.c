...
const struct ROMChapterData Chapter00 = {
    ...
    .chapTitleTextId = MSG_CHAPTER_00_TITLE,
    ...
    .mapBgmIds = {
        [MAP_BGM_BLUE] = SONG_GRIM_JOURNEY,
        [MAP_BGM_RED] = SONG_SHADOW_OF_THE_ENEMY,
        [MAP_BGM_GREEN] = SONG_SHADOW_OF_THE_ENEMY,
    ...
    .goalWindowDataType = GOAL_TYPE_DEFEAT_ALL, // GOAL_TYPE_DEFEAT_ALL,
