...
const struct DebuffInfo gDebuffInfos[NEW_UNIT_STATUS_MAX] = {
	...
	[NEW_UNIT_STATUS_BOUND] = {
		.name = MSG_DEBUFF_BOUND_NAME,
		.desc = MSG_DEBUFF_BOUND_DESC,
		.positive_type = STATUS_DEBUFF_NEGATIVE,
		.tick_type = STATUS_DEBUFF_TICK_ON_ENEMY,
		.duration = 3,
		.efx_config = {EFX_DEBUFF_NORMAL, 0x10, 0, 0},
	...
	[NEW_UNIT_STATUS_QUICKEN] = {
		.name = MSG_DEBUFF_QUICKEN_NAME,
		.desc = MSG_DEBUFF_QUICKEN_DESC,
		.positive_type = STATUS_DEBUFF_NEGATIVE,
		.tick_type = STATUS_DEBUFF_TICK_ON_ALLY,
		.duration = 1,
		.efx_config = {EFX_DEBUFF_NORMAL, 0x10, 0, 0},
	...
	[NEW_UNIT_STATUS_DELAY] = {
		.name = MSG_DEBUFF_DELAY_NAME,
		.desc = MSG_DEBUFF_DELAY_DESC,
		.positive_type = STATUS_DEBUFF_NEGATIVE,
		.tick_type = STATUS_DEBUFF_TICK_ON_ENEMY,
		.duration = 1,
		.efx_config = {EFX_DEBUFF_NORMAL, 0x10, 0, 0},
	...
	[NEW_UNIT_STATUS_RENEWAL] = {
		.name = MSG_DEBUFF_RENEWAL_NAME,
		.desc = MSG_DEBUFF_RENEWAL_DESC,
		.positive_type = STATUS_DEBUFF_POSITIVE,
		.tick_type = STATUS_DEBUFF_TICK_ON_ENEMY,
		.duration = 3,
		.efx_config = {EFX_DEBUFF_NORMAL, 0x10, 0, 0},
	...
	[NEW_UNIT_STATUS_INVEST] = {
		.name = MSG_DEBUFF_INVEST_NAME,
		.desc = MSG_DEBUFF_INVEST_DESC,
		.positive_type = STATUS_DEBUFF_POSITIVE,
		.tick_type = STATUS_DEBUFF_TICK_ON_ALLY,
		.duration = 1,
		.efx_config = {EFX_DEBUFF_NORMAL, 0x0, 0x0, 0x8},
