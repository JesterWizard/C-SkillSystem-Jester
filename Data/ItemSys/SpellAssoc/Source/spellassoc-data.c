...
const struct SpellAssoc gSpellAssocData_Rework[] = {
	...
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_SWORD_POISON),
	...
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_LANCE_POISON),
	...
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_AXE_POISON),
	...
	SPELL_ASSOC_DATA_WPN(ITEM_BOW_POISON, 2),
	...
	SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_ANIMA_ELFIRE, 0x48, SPELL_ASSOC_MCOLOR_FIRE),
	...
	SPELL_ASSOC_DATA(ITEM_STAFF_FORCE, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_TEMPEST, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_ACUITY, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_SPRINT, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_FORTUNE, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_IRON, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_OMNI, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_RUNE, 1, -2, ProcScr_LightRuneAnim, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_MINE, 1, -2, ProcScr_MineFx, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_SLOW, 2, 0x30, ProcScr_SpellAssocSleep, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_FORGE, 2, 0x30, ProcScr_SpellAssocSleep, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_REWARP, 2, 0x30, ProcScr_SpellAssocWarp, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_POISON, 2, 0x30, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_DELAY, 2, 0x30, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_ENTRAP, 2, 0x30, ProcScr_SpellAssocWarp, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_QUICKEN, 2, 0x30, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_HIDE, 2, 0x30, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_PROVOKE, 2, 0x30, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_PETRIFY, 2, 0x30, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_SOOTH, 2, 0x30, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_ENFEEBLE, 2, 0x30, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_INVEST, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_WHITE_WIND, 2, 0x28, ProcScr_SpellAssocRecover, true, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_GREEN_WIND, 1, -2, ProcScr_LightRuneAnim, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA(ITEM_STAFF_KIRIN, 1, -2, ProcScr_LightRuneAnim, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),

   	SPELL_ASSOC_DATA(ITEM_LIGHTRUNE, 1, -2, ProcScr_LightRuneAnim, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
 	SPELL_ASSOC_DATA(ITEM_MINE, 1, -2, ProcScr_MineFx, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
	...
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_MONSTER_ROTTEN_CLAW),
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_MONSTER_FETID_CLAW),
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_MONSTER_POISON_CLAW ),
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_MONSTER_LETHAL_TALON),
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_MONSTER_SHARPCLAW),
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_MONSTER_FIRE_FANG),
	SPELL_ASSOC_DATA_WPN_DEFAULT(ITEM_MONSTER_HELL_FANG),

	SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_MONSTER_EVIL_EYE, 0x43, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_MONSTER_CRIMSON_EYE, 0x42, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_MONSTER_STONE, 0x3E, SPELL_ASSOC_MCOLOR_NORMAL),
	SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_MONSTER_DEMON_SURGE, 0x45, SPELL_ASSOC_MCOLOR_NORMAL),
	...
	SPELL_ASSOC_DATA_WPN_MAGIC(ITEM_MONSTER_SHADOW_SHOT, 0x44, SPELL_ASSOC_MCOLOR_DARK),
	...
	SPELL_ASSOC_DATA(ITEM_NIGHTMARE, 1 /* 2 */, -1, ProcScr_SpellAssocNightMare, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
