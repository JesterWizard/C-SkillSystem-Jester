...
const struct SpellAssoc gSpellAssocData_Rework[] = {
    ...
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_FORCE_STAFF, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_TEMPEST_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_TEMPEST_STAFF, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_ACUITY_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_ACUITY_STAFF, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_SPRINT_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_SPRINT_STAFF, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_FORTUNE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_FORTUNE_STAFF, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_IRON_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_IRON_STAFF, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_OMNI_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_OMNI_STAFF, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_RUNE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_RUNE_STAFF, 1, -2, ProcScr_LightRuneAnim, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_MINE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_MINE_STAFF, 1, -2, ProcScr_MineFx, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_SLOW_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_SLOW_STAFF, 2, 0x30, ProcScr_SpellAssocSleep, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_FORGE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_FORGE_STAFF, 2, 0x30, ProcScr_SpellAssocSleep, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_REWARP_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_REWARP_STAFF, 2, 0x30, ProcScr_SpellAssocWarp, false, MA_FACING_DEFAULT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_POISON_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_POISON_STAFF, 2, 0x30, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_DELAY_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_DELAY_STAFF, 2, 0x30, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_ENTRAP_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_ENTRAP_STAFF, 2, 0x30, ProcScr_SpellAssocWarp, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_QUICKEN_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_QUICKEN_STAFF, 2, 0x30, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_HIDE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_HIDE_STAFF, 2, 0x30, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_PROVOKE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_PROVOKE_STAFF, 2, 0x30, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_PETRIFY_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_PETRIFY_STAFF, 2, 0x30, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_SOOTH_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_SOOTH_STAFF, 2, 0x30, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_ENFEEBLE_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_ENFEEBLE_STAFF, 2, 0x30, ProcScr_SpellAssocBerserk, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
#ifdef CONFIG_ITEM_INDEX_INVEST_STAFF
    SPELL_ASSOC_DATA(CONFIG_ITEM_INDEX_INVEST_STAFF, 2, 0x31, ProcScr_SpellAssocBarrier, false, MA_FACING_OPPONENT, SPELL_ASSOC_MCOLOR_NORMAL),
#endif
