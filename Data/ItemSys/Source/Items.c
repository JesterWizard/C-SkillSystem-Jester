...
const struct ItemData gItemData_New[255] = {
	...
	[ITEM_METISSTOME] = {
		.nameTextId = 0x3f5,
		.descTextId = MSG_ITEM_METIS_TOME_DESC,
		.useDescTextId = 0x4df,
	...
	[ITEM_MONSTER_DEMON_SURGE] = {
		.nameTextId = 0x3c0,
		.descTextId = 0x46f,
		.number = ITEM_MONSTER_DEMON_SURGE,
		.weaponType = ITYPE_DARK,
		.attributes = IA_WEAPON | IA_MAGIC | IA_UNBREAKABLE,
		.might = 11,
		.hit = 80,
	...
	[ITEM_MONSTER_SHADOW_SHOT] = {
		.nameTextId = 0x3c1,
		.descTextId = 0x470,
		.number = ITEM_MONSTER_SHADOW_SHOT,
		.weaponType = ITYPE_DARK,
		.attributes = IA_WEAPON | IA_MAGIC | IA_UNCOUNTERABLE,
		.maxUses = 5,
		.might = 13,
	...
	[ITEM_MONSTER_ROTTEN_CLAW] = {
		.nameTextId = 0x39e,
		.descTextId = 0x44e,
		.number = ITEM_MONSTER_ROTTEN_CLAW,
		.weaponType = ITYPE_11,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_LOCK_3,
		.might = 7,
		.hit = 80,
	...
	[ITEM_MONSTER_FETID_CLAW] = {
		.nameTextId = 0x39f,
		.descTextId = 0x44f,
		.number = ITEM_MONSTER_FETID_CLAW,
		.weaponType = ITYPE_11,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_LOCK_3,
		.might = 12,
		.hit = 75,
	...
	[ITEM_MONSTER_POISON_CLAW] = {
		.nameTextId = 0x3a0,
		.descTextId = 0x450,
		.number = ITEM_MONSTER_POISON_CLAW,
		.weaponType = ITYPE_11,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_LOCK_3,
		.might = 6,
		.hit = 65,
	...
	[ITEM_MONSTER_LETHAL_TALON] = {
		.nameTextId = 0x3a1,
		.descTextId = 0x451,
		.number = ITEM_MONSTER_LETHAL_TALON,
		.weaponType = ITYPE_11,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_LOCK_3,
		.might = 10,
		.hit = 60,
	...
	[ITEM_MONSTER_FIRE_FANG] = {
		.nameTextId = 0x3a2,
		.descTextId = 0x452,
		.number = ITEM_MONSTER_FIRE_FANG,
		.weaponType = ITYPE_11,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_LOCK_3,
		.might = 5,
		.hit = 90,
	...
	[ITEM_MONSTER_HELL_FANG] = {
		.nameTextId = 0x3a3,
		.descTextId = 0x453,
		.number = ITEM_MONSTER_HELL_FANG,
		.weaponType = ITYPE_11,
		.attributes = IA_WEAPON | IA_UNBREAKABLE | IA_LOCK_3,
		.might = 13,
		.hit = 80,
	...
	[ITEM_MONSTER_EVIL_EYE] = {
		.nameTextId = 0x3be,
		.descTextId = 0x46d,
		.number = ITEM_MONSTER_EVIL_EYE,
		.weaponType = ITYPE_DARK,
		.attributes = IA_WEAPON | IA_MAGIC | IA_UNBREAKABLE,
		.might = 7,
		.hit = 85,
	...
	[ITEM_MONSTER_CRIMSON_EYE] = {
		.nameTextId = 0x3bf,
		.descTextId = 0x46e,
		.number = ITEM_MONSTER_CRIMSON_EYE,
		.weaponType = ITYPE_DARK,
		.attributes = IA_WEAPON | IA_MAGIC | IA_UNBREAKABLE,
		.might = 14,
		.hit = 70,
    ...
    .encodedRange = 0x11,
    .costPerUse = 8000,
	.iconId = ITEM_ICON_SKILL_STEALER,
    .useEffectId = 0,
},
#else
	[ITEM_UNK_BE] = {
	...
	[ITEM_STAFF_FORTUNE] = {
		...
		.encodedRange = 0x11, // Adjacent allies only 1-1
		.costPerUse = 500,
		.iconId = ITEM_ICON_STAFF_FORTUNE,
		.useEffectId = IER_STAFF_BARRIER,
		.weaponRank = WPN_EXP_C,
		.weaponExp = 4,
		.hit = 100,
	...
	[ITEM_STAFF_TEMPEST] = {
		...
		.encodedRange = 0x11, // Adjacent allies only 1-1
		.costPerUse = 500,
		.iconId = ITEM_ICON_STAFF_TEMPEST,
		.useEffectId = IER_STAFF_BARRIER,
		.weaponRank = WPN_EXP_C,
		.weaponExp = 4,
		.hit = 100,
	...
	[ITEM_STAFF_RUNE] = {
		...
		.encodedRange = 0x11, // Adjacent allies only 1-1
		.costPerUse = 500,
		.iconId = ITEM_ICON_STAFF_RUNE,
		.useEffectId = IER_STAFF_RUNE,
		.weaponRank = WPN_EXP_C,
		.weaponExp = 4,
		.hit = 100,
		.attributes = IA_STAFF,
	...
	[ITEM_STAFF_SLOW] = {
		...
		.encodedRange = 0x11, // Adjacent allies only 1-1
		.costPerUse = 500,
		.iconId = ITEM_ICON_STAFF_SLOW,
		.useEffectId = IER_STAFF_SLOW,
		.weaponRank = WPN_EXP_C,
		.weaponExp = 4,
		.hit = 100,
		.attributes = IA_STAFF,
    ...
    .encodedRange = 0x10,
    .costPerUse = 500,
	.iconId = ITEM_ICON_STAFF_FORGE,
	.useEffectId = IER_STAFF_FORGE,
    .weaponRank = WPN_EXP_C,
    .weaponExp = 4,
    .hit = 100,
    .attributes = IA_STAFF,
	...
	[ITEM_STAFF_ENTRAP] = {
		...
		.encodedRange = 0x10,
		.costPerUse = 8000,
		.iconId = ITEM_ICON_STAFF_ENTRAP,
		.useEffectId = IER_STAFF_ENTRAP,
		.weaponRank = WPN_EXP_C,
		.weaponExp = 4,
		.hit = 100,
		.weight = 5,
	...
	[ITEM_STAFF_QUICKEN] = {
		...
		.encodedRange = 0x11,
		.costPerUse = 8000,
		.iconId = ITEM_ICON_STAFF_QUICKEN,
		.useEffectId = IER_STAFF_QUICKEN,
		.weaponRank = WPN_EXP_C,
		.weaponExp = 4,
		.hit = 100,
		.weight = 5,
	...
	[ITEM_STAFF_HIDE] = {
		...
		.encodedRange = 0x11,
		.costPerUse = 8000,
		.iconId = ITEM_ICON_STAFF_HIDE,
		.useEffectId = IER_STAFF_HIDE,
		.weaponRank = WPN_EXP_C,
		.weaponExp = 4,
		.hit = 100,
		.weight = 5,
	...
	[ITEM_STAFF_PROVOKE] = {
		...
		.encodedRange = 0x11,
		.costPerUse = 8000,
		.iconId = ITEM_ICON_STAFF_PROVOKE,
	...
	[ITEM_STAFF_PETRIFY] = {
		...
		.encodedRange = 0x13,
		.costPerUse = 8000,
		.iconId = ITEM_ICON_STAFF_PETRIFY,
		.useEffectId = IER_STAFF_PETRIFY,
		.weaponRank = WPN_EXP_C,
		.weaponExp = 4,
		.hit = 100,
		.weight = 5,
	...
	[ITEM_STAFF_ENFEEBLE] = {
		...
		.encodedRange = 0x13,
		.costPerUse = 8000,
		.iconId = ITEM_ICON_STAFF_ENFEEBLE,
	...
	[ITEM_STAFF_AUM] = {
		.nameTextId = MSG_ITEM_AUM_STAFF_NAME,
		.descTextId = MSG_ITEM_AUM_STAFF_DESC,
		.useDescTextId = MSG_ITEM_AUM_STAFF_USEDESC,
		.number = ITEM_STAFF_AUM,
		.weaponType = ITYPE_STAFF,
		.pStatBonuses = NULL,
		.maxUses = 3,
		.encodedRange = 0x11,
	...
	[ITEM_STAFF_PHOENIX] = {
		.nameTextId = MSG_ITEM_PHOENIX_STAFF_NAME,
		.descTextId = MSG_ITEM_PHOENIX_STAFF_DESC,
		.useDescTextId = MSG_ITEM_PHOENIX_STAFF_USEDESC,
		.number = ITEM_STAFF_PHOENIX,
		.weaponType = ITYPE_STAFF,
		.pStatBonuses = NULL,
		.maxUses = 1,
		.encodedRange = 0x11,
	...
	[ITEM_STAFF_SKILL] = {
		.nameTextId = MSG_ITEM_SKILL_STAFF_NAME,
		.descTextId = MSG_ITEM_SKILL_STAFF_DESC,
		.useDescTextId = MSG_ITEM_SKILL_STAFF_USEDESC,
		.number = ITEM_STAFF_SKILL,
		.weaponType = ITYPE_STAFF,
		.pStatBonuses = NULL,
		.maxUses = 3,
		.encodedRange = 0x11,
	...
	[ITEM_STAFF_AGAIN] = {
		.nameTextId = MSG_ITEM_AGAIN_STAFF_NAME,
		.descTextId = MSG_ITEM_AGAIN_STAFF_DESC,
		.useDescTextId = MSG_ITEM_AGAIN_STAFF_USEDESC,
		.number = ITEM_STAFF_AGAIN,
		.weaponType = ITYPE_STAFF,
		.pStatBonuses = NULL,
		.maxUses = 5,
		.encodedRange = 0x11,
	...
	[ITEM_STAFF_ABORT] = {
		.nameTextId = MSG_ITEM_ABORT_STAFF_NAME,
		.descTextId = MSG_ITEM_ABORT_STAFF_DESC,
		.useDescTextId = MSG_ITEM_ABORT_STAFF_USEDESC,
		.number = ITEM_STAFF_ABORT,
		.weaponType = ITYPE_STAFF,
		.pStatBonuses = NULL,
		.maxUses = 5,
		.encodedRange = 0x11,
	...
	[ITEM_STAFF_WHITE_WIND] = {
		.nameTextId = MSG_ITEM_WHITE_WIND_STAFF_NAME,
		.descTextId = MSG_ITEM_WHITE_WIND_STAFF_DESC,
		.useDescTextId = MSG_ITEM_WHITE_WIND_STAFF_USEDESC,
		.number = ITEM_STAFF_WHITE_WIND,
		.weaponType = ITYPE_STAFF,
		.pStatBonuses = NULL,
		.maxUses = 5,
		.encodedRange = 0x11,
		.costPerUse = 8000,
		.iconId = ITEM_ICON_STAFF_SOOTH,
		.useEffectId = IER_STAFF_WHITE_WIND,
		.weaponRank = WPN_EXP_B,
		.weaponExp = 4,
		.hit = 100,
		.weight = 5,
	...
	[ITEM_STAFF_GREEN_WIND] = {
		.nameTextId = MSG_ITEM_GREEN_WIND_STAFF_NAME,
		.descTextId = MSG_ITEM_GREEN_WIND_STAFF_DESC,
		.useDescTextId = MSG_ITEM_GREEN_WIND_STAFF_USEDESC,
		.number = ITEM_STAFF_GREEN_WIND,
		.weaponType = ITYPE_STAFF,
		.pStatBonuses = NULL,
		.maxUses = 5,
		.encodedRange = 0x11,
		.costPerUse = 8000,
		.iconId = ITEM_ICON_STAFF_SOOTH,
		.useEffectId = IER_STAFF_GREEN_WIND,
		.weaponRank = WPN_EXP_B,
		.weaponExp = 4,
		.hit = 100,
		.weight = 5,
	...
	[ITEM_STAFF_KIRIN] = {
		.nameTextId = MSG_ITEM_KIRIN_STAFF_NAME,
		.descTextId = MSG_ITEM_KIRIN_STAFF_DESC,
		.useDescTextId = MSG_ITEM_KIRIN_STAFF_USEDESC,
		.number = ITEM_STAFF_KIRIN,
		.weaponType = ITYPE_STAFF,
		.pStatBonuses = NULL,
		.maxUses = 5,
		.encodedRange = 0x13,
	...
	[ITEM_KNIFE_IRON] = {
		.nameTextId = MSG_ITEM_IRON_KNIFE_NAME,
		.descTextId = MSG_ITEM_IRON_KNIFE_DESC,
		.useDescTextId = MSG_ITEM_IRON_KNIFE_DESC,
		.number = ITEM_KNIFE_IRON,
		.weaponType = ITYPE_KNIFE,
		.attributes = IA_WEAPON,
		.maxUses = 40,
		.might = 4,
		.hit = 90,
