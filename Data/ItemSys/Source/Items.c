...
const struct ItemData gItemData_New[255] = {
	...
	[CONFIG_ITEM_INDEX_ENTRAP_STAFF] = {
		...
		.encodedRange = 0x10,
		.costPerUse = 8000,
		.iconId = CONFIG_ICON_INDEX_ENTRAP_STAFF,
	...
	[CONFIG_ITEM_INDEX_QUICKEN_STAFF] = {
		...
		.encodedRange = 0x11,
		.costPerUse = 8000,
		.iconId = CONFIG_ICON_INDEX_QUICKEN_STAFF,
	...
	[CONFIG_ITEM_INDEX_HIDE_STAFF] = {
		...
		.encodedRange = 0x11,
		.costPerUse = 8000,
		.iconId = CONFIG_ICON_INDEX_HIDE_STAFF,
	...
	[CONFIG_ITEM_INDEX_PETRIFY_STAFF] = {
		...
		.encodedRange = 0x13,
		.costPerUse = 8000,
		.iconId = CONFIG_ICON_INDEX_PETRIFY_STAFF,
	...
	[CONFIG_ITEM_INDEX_ENFEEBLE_STAFF] = {
		...
		.encodedRange = 0x13,
		.costPerUse = 8000,
		.iconId = CONFIG_ICON_INDEX_ENFEEBLE_STAFF,
