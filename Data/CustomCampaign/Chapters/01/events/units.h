...
static const struct UnitDefinition CH1_REINFORCEMENTS_ALLIES[] = {
    UNIT_ENTRY(CHARACTER_FRANZ, CLASS_CAVALIER, FACTION_ID_BLUE, NO_ITEM_DROP, NO_AUTOLEVEL, 1, 7, 0, 1, REDAs_FRANZ, 0, 0, 0, 0, ITEM_SWORD_IRON, ITEM_LANCE_IRON, ITEM_VULNERARY, ITEM_VULNERARY),
...
static const struct UnitDefinition CH1_FRELIAN_FORCES[] = {
    ...
    UNIT_ENTRY(0xC0, CLASS_MERCENARY, FACTION_ID_GREEN, NO_ITEM_DROP, AUTOLEVEL, 1, 2, 2, NO_REDA, NO_REDA, 0, 0, 0, 0, ITEM_SWORD_IRON),
    {}
};
