static const EventScr EventScr_Ch01_Opening[] = {
    MUSC(SONG_TENSION)
...
const EventScr EventScr_Ch01_Ending[] = {
    ASMC(GrantBEXP)
    MUSC(SONG_VICTORY)
...
static const EventListScr EventListScr_Ch01_Location[] = {
...
static const EventListScr EventListScr_Ch01_Misc[] = {
