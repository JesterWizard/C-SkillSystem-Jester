...
static const EventScr EventScr_Ch05x_Opening[] = {
    ...
    MOVE_CAMERA_TO_POSITION_CENTER(9, 9)
    FADE_TO_BLACK(16)
...
const EventScr EventScr_Ch05x_Ending[] = {
    ASMC(GrantBEXP)
...
static const EventListScr EventListScr_Ch05x_Turn[] = {
    END_MAIN
};

static const EventListScr EventListScr_Ch05x_Character[] = {
    END_MAIN
};

static const EventListScr EventListScr_Ch05x_Location[] = {
...
static const EventListScr EventListScr_Ch05x_Misc[] = {
