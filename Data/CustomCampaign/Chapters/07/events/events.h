static const EventScr EventScr_Ch07_Opening[] = {
...
const EventScr EventScr_Ch07_Ending[] = {
    ASMC(GrantBEXP)
    FADE_FROM_BLACK(16)
    LOMA(0x44)
    CLEAR_ALL_UNITS
...
static const EventListScr EventListScr_Ch07_Turn[] = {
    END_MAIN
};

static const EventListScr EventListScr_Ch07_Character[] = {
    END_MAIN
};

static const EventListScr EventListScr_Ch07_Location[] = {
...
static const EventListScr EventListScr_Ch07_Misc[] = {
