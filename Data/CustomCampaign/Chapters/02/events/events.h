// --- Opening Cinematics ---
static const EventScr EventScr_Ch02_Opening[] = {
    MUSC(SONG_ADVANCE)
    ...
    SOUN(SONG_SE_VILLAGE_DESTROYED)
    TILECHANGE_COORDINATES(12, 2)
    SOUN(SONG_SE_WEAPON_BROKE)
    NOTIFY(NOTIFY_village_was_destroyed, SONG_NONE)
...
const EventScr EventScr_Ch02_Ending[] = {
    ASMC(GrantBEXP)
    MUSC(SONG_VICTORY)
...
// --- Turn Events ---
static const EventListScr EventListScr_Ch02_Turn[] = {
    END_MAIN
};

// - Facilitate Talk Scenes ---
static const EventListScr EventListScr_Ch02_Character[] = {
...
static const EventListScr EventListScr_Ch02_Location[] = {
...
// --- Other Scenes ---
static const EventListScr EventListScr_Ch02_Misc[] = {
    DEFEAT_ALL(EventScr_Ch02_Ending)
