static const EventScr EventScr_Ch00_Opening[] = {
...
const EventScr EventScr_Ch00_Ending[] = {
    ASMC(GrantBEXP)
...
static const EventListScr EventListScr_Ch00_Turn[] = {
...
static const EventListScr EventListScr_Ch00_Character[] = {
    // CharacterEventBothWays(EVFLAG_TMP(9), EventScr_Talk_EIRIKA_SETH, CHARACTER_EIRIKA, CHARACTER_SETH)
    END_MAIN
};

static const EventListScr EventListScr_Ch00_Location[] = {
    END_MAIN
};

static const EventListScr EventListScr_Ch00_Misc[] = {
    DEFEAT_ALL(EventScr_Ch00_Ending)
