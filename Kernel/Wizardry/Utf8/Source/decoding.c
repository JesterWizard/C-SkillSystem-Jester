...
#if defined(CONFIG_FONT_MOTHER_3) || defined(CONFIG_FONT_RIVIERA) || defined(CONFIG_FONT_MINISH_CAP) || defined(CONFIG_FONT_RED_RESCUE_TEAM) || defined(CONFIG_FONT_POKE_FIRERED) || defined(CONFIG_FONT_DUEL_ACADEMY)
