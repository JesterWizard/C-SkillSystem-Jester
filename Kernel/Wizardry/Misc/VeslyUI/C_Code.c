...
const u8 * GetPIFontTiles(void)
{
    ...
    if (!id)
    {
        return gGfx_PlayerInterfaceFontTiles;
    }
...
const u8 * GetPINumbers(void)
{
    ...
    if (!id)
    {
        return gGfx_PlayerInterfaceNumbers;
    }
...
const u8 * GetPrepUseItem(void)
{
    ...
    if (!id)
    {
        return (u8 *)Img_PrepItemUseScreen;
    }
