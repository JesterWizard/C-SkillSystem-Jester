...
static s8 CanUnitCrossTerrain2(struct Unit* unit, int terrain) {
...
u8 ViewSupplyNow(struct MenuProc * menu, struct MenuItemProc * menuItem) {
	DebuggerProc* proc;
	proc = Proc_Find(DebuggerProcCmd);
