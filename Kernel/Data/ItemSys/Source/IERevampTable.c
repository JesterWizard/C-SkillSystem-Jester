...
struct IERevamp const IERevampTable[IER_MAX] = {
	...
	[IER_STAFF_KIRIN] = {
		.usability      = IER_Usability_Kirin,
		.prep_usability = NULL,
		.effect         = IER_Effect_Kirin,
		.action_effect  = IER_Action_Kirin,
		.prep_effect    = NULL,
	},
	[IER_STAFF_SILENCE] = {
	...
	[IER_STAFF_AUM] = {
		.usability      = IER_Usability_Aum,
		.prep_usability = NULL,
		.effect         = IER_Effect_Aum,
		.action_effect  = IER_Action_Aum,
		.prep_effect    = NULL,
	},
	[IER_STAFF_PHOENIX] = {
		.usability      = IER_Usability_Phoenix,
		.prep_usability = NULL,
		.effect         = IER_Effect_Phoenix,
		.action_effect  = IER_Action_Phoenix,
		.prep_effect    = NULL,
	},
	[IER_STAFF_SKILL] = {
		.usability      = IER_Usability_SkillStaff,
		.prep_usability = NULL,
		.effect         = IER_Effect_SkillStaff,
	...
	[IER_STAFF_ABORT] = {
		.usability      = IER_Usability_Abort,
		.prep_usability = NULL,
		.effect         = IER_Effect_Abort,
		.action_effect  = IER_Action_Abort,
		.prep_effect    = NULL,
	},
	[IER_STAFF_ARBALEST] = {
		.usability      = IER_Usability_Arbalest,
		.prep_usability = NULL,
		.effect         = IER_Effect_Arbalest,
		.action_effect  = IER_Action_Arbalest,
		.prep_effect    = NULL,
	},
