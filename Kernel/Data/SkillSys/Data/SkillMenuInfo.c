...
struct MenuItemDef const* const gSkillMenuInfos[MAX_SKILL_NUM + 1] = {
	...
	[SID_EmergencyExit] = &(const struct MenuItemDef) {
		.name = "　召喚",
		.nameMsgId = MSG_SKILL_EmergencyExit_NAME,
		.helpMsgId = MSG_SKILL_EmergencyExit_DESC,
		.color = TEXT_COLOR_SYSTEM_GOLD,
    ...
    [SID_Transcendence] = &(const struct MenuItemDef) {
        .name = "　",
        .nameMsgId = MSG_SKILL_Transcendence_NAME,
        .helpMsgId = MSG_SKILL_Transcendence_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Transcendence_Usability,
        .onDraw = NULL,
        .onSelected = Transcendence_OnSelected,
        .onIdle = NULL,
        .onSwitchIn = NULL,
        .onSwitchOut = NULL,
    },
    ...
    [SID_SpatialShiftPlus] = &(const struct MenuItemDef) {
        .name = "　",
        .nameMsgId = MSG_SKILL_SpatialShiftPlus_NAME,
        .helpMsgId = MSG_SKILL_SpatialShiftPlus_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = SpatialShiftPlus_Usability,
        .onDraw = NULL,
        .onSelected = SpatialShiftPlus_OnSelected,
        .onIdle = NULL,
        .onSwitchIn = NULL,
        .onSwitchOut = NULL,
    },
    ...
    [SID_AssumingCommand] = &(const struct MenuItemDef) {
        .name = "　",
        .nameMsgId = MSG_SKILL_AssumingCommand_NAME,
        .helpMsgId = MSG_SKILL_AssumingCommand_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = AssumingCommand_Usability,
        .onDraw = NULL,
        .onSelected = AssumingCommand_OnSelected,
        .onIdle = NULL,
        .onSwitchIn = NULL,
        .onSwitchOut = NULL,
    },
    ...
    [SID_Drag] = &(const struct MenuItemDef) {
        .name = "　",
        .nameMsgId = MSG_SKILL_Drag_NAME,
        .helpMsgId = MSG_SKILL_Drag_DESC,
        .color = TEXT_COLOR_SYSTEM_GOLD,
        .isAvailable = Drag_Usability,
        .onDraw = NULL,
        .onSelected = Drag_OnSelected,
        .onIdle = NULL,
        .onSwitchIn = NULL,
        .onSwitchOut = NULL,
    },
