 ...
 * Main events
 */
static const EventScr EventScr_Ch09_Opening[] = {
...
const EventScr EventScr_Ch09_Ending[] = {
    ASMC(GrantBEXP)
...
static const EventListScr EventScr_CH9_TURN_3_REINFORCEMENTS[] = {
    ...
    TEXT(Chapter_09_In_Scene_Amelia_Arrives)
    GOTO(0x1)
...
static const EventListScr EventScr_Talk_EIRIKA_AMELIA[] = {
    MUSC(SONG_COMRADES)
    STAL(33)
    TEXT(Chapter_09_In_Scene_Amelia_Eirika)
...
static const EventListScr EventScr_Talk_FRANZ_AMELIA[] = {
    MUSC(SONG_COMRADES)
    STAL(33)
    TEXT(Chapter_09_In_Scene_Amelia_Franz)
    CHANGE_TO_BLUE(CHARACTER_AMELIA)
    ASMC(TalkEXPGain)
    NOFADE
    ENDA
...
static const EventListScr EventListScr_Ch09_Turn[] = {
    TURN(EVFLAG_TMP(7), EventScr_CH9_TURN_1_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(8), EventScr_CH9_TURN_2_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(9), EventScr_CH9_TURN_3_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(10), EventScr_CH9_TURN_4_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(11), EventScr_CH9_TURN_5_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    END_MAIN
};

static const EventListScr EventListScr_Ch09_Character[] = {
...
static const EventListScr EventListScr_Ch09_Location[] = {
...
static const EventListScr EventListScr_Ch09_Misc[] = {
    DEFEAT_ALL(EventScr_Ch09_Ending)
