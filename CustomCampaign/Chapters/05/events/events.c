 ...
 * Main events
 */
static const EventScr EventScr_Ch05_Opening[] = {
...
LABEL(0x1)
    ...
    MUSC(SONG_SOLVE_THE_RIDDLE)
    HIGHLIGHT_CHARACTER(CHARACTER_JOSHUA, 32)
...
const EventScr EventScr_Ch05_Ending[] = {
    ASMC(GrantBEXP)
...
static const EventListScr EventListScr_Ch05_Turn[] = {
    TURN(EVFLAG_TMP(7), EventScr_CH5_TURN_2_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(8), EventScr_CH5_TURN_6_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(9), EventScr_CH5_TURN_8_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    END_MAIN
};

static const EventListScr EventListScr_Ch05_Character[] = {
    END_MAIN
};

static const EventListScr EventListScr_Ch05_Location[] = {
...
static const EventListScr EventListScr_Ch05_Misc[] = {
    DEFEAT_ALL(EventScr_Ch05_Ending)
