...
LABEL(0x1)
    ...
    WM_SETNODESTATENOT2(WM_NODE_BorderMulan)
    WM_SETCAM(0, 12)
    WM_FADEOUT(0)
    ...
    WM_VOICE_LINE(SONG_VOICE_CH01_LINE_0001)

    // As she leaves the area with Princess Tana in tow, she cannot help but mourn the lost lives.
    WM_VOICE_LINE(SONG_VOICE_CH01_LINE_0002)

    WM_VOICE_LINE(SONG_VOICE_CH01_LINE_0003)

    WM_VOICE_LINE(SONG_VOICE_CH01_LINE_0004)

    STAL(20)
    WM_MOVESPRITETO(WM_MU_0, 0x0000, WM_NODE_BorderMulan, WM_NODE_CastleFrelia, 200, 40)

    WM_VOICE_LINE(SONG_VOICE_CH01_LINE_0005)
