...
static const EventScr EventScr_Ch08_Opening[] = {
    MUSC(SONG_TENSION)
...
const EventScr EventScr_Ch08_Ending[] = {
    ASMC(GrantBEXP)
    MUSC(SONG_NONE)
    SET_BACKGROUND(0x10)
...
static const EventListScr EventListScr_Ch08_Turn[] = {
...
static const EventListScr EventListScr_Ch08_Character[] = {
...
static const EventListScr EventListScr_Ch08_Location[] = {
...
static const EventListScr EventListScr_Ch08_Misc[] = {
