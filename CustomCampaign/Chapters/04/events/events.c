...
static const EventScr EventScr_Ch04_Opening[] = {
...
const EventScr EventScr_Ch04_Ending[] = {
    ASMC(GrantBEXP)
    MUSC(SONG_VICTORY)
...
static const EventListScr EventListScr_Ch04_Turn[] = {
    TURN(EVFLAG_TMP(7), EventScr_CH4_LARACHEL_APPEARS, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(8), EventScr_CH4_GARCIA_APPEARS, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(9), EventScr_CH4_BONEWALKERS_APPEAR, 1, 255, FACTION_BLUE)
    TURN(EVFLAG_TMP(10), EventScr_CH4_REVENANTS_APPEAR, 1, 255, FACTION_BLUE)
    END_MAIN
};

static const EventListScr EventListScr_Ch04_Character[] = {
    CharacterEventBothWays(EVFLAG_TMP(11), EventScr_Talk_ROSS_GARCIA, CHARACTER_ROSS, CHARACTER_GARCIA)
    END_MAIN
};

static const EventListScr EventListScr_Ch04_Location[] = {
    VILLAGE(EVFLAG_TMP(12), EventListScr_VILLAGE_1_TALK, 8, 2)
    VILLAGE(EVFLAG_TMP(13), EventListScr_VILLAGE_2_TALK, 1, 11)
    END_MAIN
};

static const EventListScr EventListScr_Ch04_Misc[] = {
    DEFEAT_ALL(EventScr_Ch04_Ending)
