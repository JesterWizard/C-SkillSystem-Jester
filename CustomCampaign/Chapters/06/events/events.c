...
static const EventScr EventScr_Ch06_Opening[] = {
...
const EventScr EventScr_Ch06_Ending[] = {
    ASMC(GrantBEXP)
    MUSC(SONG_NONE)
    CHECK_ALIVE(0xfa)
...
static const EventListScr EventListScr_Ch06_Turn[] = {
    TURN(EVFLAG_TMP(7), EventScr_CH6_TURN_4_REINFORCEMENTS, 1, 255, FACTION_BLUE)
    END_MAIN
};

static const EventListScr EventListScr_Ch06_Character[] = {
    END_MAIN
};

static const EventListScr EventListScr_Ch06_Location[] = {
    VILLAGE(EVFLAG_TMP(10), EventListScr_HOUSE_1_TALK, 11, 18)
    END_MAIN
};

static const EventListScr EventListScr_Ch06_Misc[] = {
    DEFEAT_BOSS(EventScr_Ch06_Ending)
