 ...
 * Main events
 */
static const EventScr EventScr_Ch03_Opening[] = {
    MUSC(SONG_LEGACY)
...
const EventScr EventScr_Ch03_Ending[] = {
    ASMC(GrantBEXP)
    MUSC(SONG_VICTORY)
...
static const EventListScr EventListScr_Ch03_Location[] = {
...
static const EventListScr EventListScr_Ch03_Misc[] = {
