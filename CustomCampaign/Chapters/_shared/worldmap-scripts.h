...
extern const EventScr EventScrWM_Intermission_Renvall_To_Serafew[];
extern const EventScr EventScrWM_Intermission_Serafew_To_Frelia[];
...
extern const EventScr EventScrWM_Ch5x_STUFF[];
