...
extern const EventScr EventScr_Ch00_Ending[];
extern const EventScr EventScr_Ch01_Ending[];
extern const EventScr EventScr_Ch02_Ending[];
extern const EventScr EventScr_Ch03_Ending[];
extern const EventScr EventScr_Ch04_Ending[];
extern const EventScr EventScr_Ch05_Ending[];
extern const EventScr EventScr_Ch05x_Ending[];
extern const EventScr EventScr_Ch06_Ending[];
extern const EventScr EventScr_Ch07_Ending[];
extern const EventScr EventScr_Ch08_Ending[];
extern const EventScr EventScr_Ch09_Ending[];
extern const EventScr EventScr_Ch10_Ending[];
