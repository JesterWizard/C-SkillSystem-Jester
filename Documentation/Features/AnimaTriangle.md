...
| **WTA logic** | `WTA_HandlerWeapon` (inside `gpKernelDesignerConfig->anima_weapon_triangle`) in [`WeaponTriangle.c`](../../Kernel/Wizardry/BattleSys/Source/WeaponTriangle.c) | Applies the triangle logic during combat |
