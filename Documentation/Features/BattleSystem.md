...
The **HP cost** is a new combat mechanic introduced in the c-Skillsys, inspired by the *Gaiden magic system*. The related code is mainly stored in [BattleSys/HpCost](../Kernel/Wizardry/BattleSys/HpCost/) and [BattleSys/RoundAnim](../Kernel/Wizardry/BattleSys/RoundAnim/) directory.
