...
- `Data/CustomCampaign/Chapters/01/events/traps.c`
...
| Chapter trap declaration | `Data/CustomCampaign/Chapters/01/events/traps.c` | Defines startup trap arrays for normal/hard modes |
| Chapter trap binding | `Data/CustomCampaign/Chapters/00/events/events.c` | Connects trap arrays via `.traps` and `.extraTrapsInHard` |
| Event ASMC call site | `Data/CustomCampaign/Chapters/00/events/events.c` | Invokes ASMC function during chapter event flow |
