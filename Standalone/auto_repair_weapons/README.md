...
1. Copy the `auto_repair_weapons` folder (or download this standalone package).
...
```bash
ColorzCore A FE8 -input:Installer.event -output:/path/to/fe8-auto-repair-weapons.gba
```
