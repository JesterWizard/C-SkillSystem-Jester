...
1. Copy the `custom_battle_quotes` folder (or download this standalone package).
...
```bash
ColorzCore A FE8 -input:Installer.event -output:/path/to/fe8-custom-battle-quotes.gba
```
