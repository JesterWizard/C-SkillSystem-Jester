...
1. Copy the `arena_show_opponent_in_advance` folder (or download this standalone package).
...
```bash
ColorzCore A FE8 -input:Installer.event -output:/path/to/fe8-arena-preview.gba
```
