...
1. Copy the `alpha_blend_movement_sprites` folder (or download this standalone package).
...
```bash
ColorzCore A FE8 -input:Installer.event -output:/path/to/fe8-alpha-blend-movement-sprites.gba
```
