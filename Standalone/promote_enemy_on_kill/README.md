...
1. Copy the `promote_enemy_on_kill` folder (or download this standalone package).
...
```bash
ColorzCore A FE8 -input:Installer.event -output:/path/to/fe8-promote-enemy-on-kill.gba
```
