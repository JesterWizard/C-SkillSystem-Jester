...
/* Vanilla gProcScr_GMapPlayerInterface; not named in FE-CLib. */
#define ProcScr_GMapPlayerInterface ((struct ProcCmd *)0x08A3E464)

static void WorldMap_CenterCamera(ProcPtr proc, int nodeid);
...
static const struct ProcCmd sProcScr_WorldMapThoughtBubble[] = {
...
void WorldMap_LoopExt_ThoughtBubbles(struct WorldMapMainProc *proc)
{
	int nodeId;
...
struct MenuProc *StartWMNodeMenu_ThoughtBubbles(struct WorldMapMainProc *parent)
{
