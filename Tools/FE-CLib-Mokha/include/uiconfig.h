...
enum
{
    ...
    GAME_OPTION_TALK_ON_LEVEL_UP = 20,
    GAME_OPTION_RESTORE_HP_ON_LEVEL_UP = 21,
    GAME_OPTION_PROMOTE_ENEMY_ON_KILL = 22,
    GAME_OPTION_DANGER_BONES = 23,
    GAME_OPTION_FAST_FOWARD_BATTLE_ANIMATIONS = 24,
    GAME_OPTION_EXPANDED_MAX_HP = 25,
    GAME_OPTION_FLIPPED_ENEMY_SPRITES = 26,
    GAME_OPTION_SUMMONS_GAIN_EXP = 27,
    GAME_OPTION_PROMOTE_ON_MAX_LEVEL = 28,
    GAME_OPTION_SHOW_ARENA_OPPONENT_IN_ADVANCE = 29,
    GAME_OPTION_SEND_INVENTORY_ON_DEATH = 30,
    GAME_OPTION_FAST_MAP_ANIMATIONS = 31,
    GAME_OPTION_ANIMA_WEAPON_TRIANGLE = 32,
    GAME_OPTION_SUPPORT_AFTER_BATTLE = 33,
    GAME_OPTION_GAMEOVER_QUOTES = 34,
};
