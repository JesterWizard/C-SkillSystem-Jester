...
enum
{
    ...
    GAME_OPTION_SKILL_CAPACITY = 17,
    GAME_OPTION_CASUAL_MODE = 18,
    GAME_OPTION_TALK_ON_LEVEL_UP = 19,
    GAME_OPTION_RESTORE_HP_ON_LEVEL_UP = 20,
    GAME_OPTION_PROMOTE_ENEMY_ON_KILL = 21,
    GAME_OPTION_DANGER_BONES = 22,
    GAME_OPTION_FAST_FOWARD_BATTLE_ANIMATIONS = 23,
    GAME_OPTION_EXPANDED_MAX_HP = 24,
    GAME_OPTION_FLIPPED_ENEMY_SPRITES = 25,
    GAME_OPTION_SUMMONS_GAIN_EXP = 26,
    GAME_OPTION_PROMOTE_ON_MAX_LEVEL = 27,
    GAME_OPTION_SHOW_ARENA_OPPONENT_IN_ADVANCE = 28,
    GAME_OPTION_SEND_INVENTORY_ON_DEATH = 29,
    GAME_OPTION_FAST_MAP_ANIMATIONS = 30,
    GAME_OPTION_TUTORIALS = 31,
    GAME_OPTION_SUPPORT_AFTER_BATTLE = 32,
    GAME_OPTION_REAL_TIME_BATTLE = 33,
    GAME_OPTION_REAL_TIME_INTERVAL = 34,
    GAME_OPTION_ACHIEVEMENTS = 35,
    GAME_OPTION_SHOW_TRUE_2RN = 36,
};
...
extern const u8 gGameOptionsUiOrder_NEW[];
