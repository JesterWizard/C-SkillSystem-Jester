...
enum prep_atmenu_item_index {
    ...
    PREP_MAINMENU_CHECKMAP = 4,
    PREP_MAINMENU_BONUS_EXP = 5,
    PREP_MAINMENU_SKILLS = 6,
    PREP_MAINMENU_BASE_CONVERSATIONS = 7,
    PREP_MAINMENU_AUGURY = 8,
    PREP_MAINMENU_INFUSE = 9,
    PREP_MAINMENU_EVENT_REPLAY = 10,
    PREP_MAINMENU_SKILL_SYNTH = 11,
    // PREP_MAINMENU_UNK3 = ??
    // PREP_MAINMENU_FORMATION = 12,
