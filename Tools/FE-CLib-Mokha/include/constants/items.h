...
enum {
    ...
    ITEM_MONSTER_DEMON_SURGE = 0xAB,
    ITEM_MONSTER_SHADOW_SHOT = 0xAC,
    ITEM_MONSTER_ROTTEN_CLAW = 0xAD,
    ITEM_MONSTER_FETID_CLAW  = 0xAE,
    ITEM_MONSTER_POISON_CLAW   = 0xAF,
    ITEM_MONSTER_LETHAL_TALON = 0xB0,
    ITEM_MONSTER_FIRE_FANG  = 0xB1,
    ITEM_MONSTER_HELL_FANG = 0xB2,
    ITEM_MONSTER_EVIL_EYE   = 0xB3,
    ITEM_MONSTER_CRIMSON_EYE = 0xB4,
    ...
    ITEM_UNK_BE            = 0xBE,
    ITEM_UNK_BF            = 0xBF,
    ITEM_STAFF_FORCE       = 0xC0,
    ITEM_STAFF_ACUITY      = 0xC1,
    ITEM_STAFF_FORTUNE     = 0xC2,
    ITEM_STAFF_IRON        = 0xC3,
    ITEM_STAFF_SPRINT      = 0xC4,
    ITEM_STAFF_TEMPEST     = 0xC5,
    ...
    ITEM_UNK_CC            = 0xCC,
    ITEM_STAFF_REWARP      = 0xCD,
    ITEM_STAFF_OMNI        = 0xCE,
    ITEM_UNK_CF            = 0xCF,
    ITEM_STAFF_POISON      = 0xD0,
    ITEM_STAFF_DELAY       = 0xD1,
    ITEM_STAFF_ENTRAP      = 0xD2,
    ITEM_STAFF_QUICKEN     = 0xD3,
    ITEM_STAFF_HIDE        = 0xD4,
    ITEM_STAFF_PROVOKE     = 0xD5,
    ITEM_STAFF_PETRIFY     = 0xD6,
